        ...
        <div className="main-content grid grid-cols-3 gap-4 m-[2rem] ">
          ...
          <div className="flex flex-col items-center justify-around col-span-2 bg-[#635774] text-white p-5 ring ring-[#B1740F]">
            ...
            <p className="services-p text-justify text-xl px-12">
              ...
              texture, and personal style. A skilled hair stylist will be able
              to recommend the best haircut for a client and guide them through
              the process, from consultation to finished look. A well-executed
              haircut can enhance a person's natural beauty and make them feel
              like the best version of themselves. I believe that a good haircut
              is an essential component of any successful hair styling service.
            </p>
          </div>
        </div>
